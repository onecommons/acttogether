...
function setup(body, methods) {
  //XXX handle notifcations 
...
module.exports.router = function(req, res, next, methods, stringify) {
  if (req.headers['content-type'].indexOf( 'application/json' ) > -1) {
   Promise.all(setup(req.body, methods)).then(
    function (result) {
