...
MongooseDatastore.prototype = {
  ...
  */
  ...
  ,_update: function(mjson, cb, dostuff) {
    mjson = _getmjson(mjson);
  ...
  */
  ...
  ,destroy: function(mjson, cb) {//delete the object
    var _id = mjson._id; //XXX
  ...
  */
  ,replace: function(mjson, cb) {
    ...
    if (!model)
      return;
    var obj = new model(); //create a new instance
    for (var key in mjson) {
      if (!mjson.hasOwnProperty(key)) continue;
      obj.set(key, mjson[key]);
    }
    //XXX do lowlevel collection.save() replace document
  }
