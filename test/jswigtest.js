...
describe('clientinclude', function() {
  ...
  it('should parse clientinclude tag correctly', function(done){
      request(app).get('/test-clientinclude.html')
        .expect('<html>\n<div id=\'dom1\'>\n<div>hello</div>\n\n\n</div>\n\n<div id=\'dom2\'>\n\n</div>\n\n<div id=\'dom3\'>\n\n</div>\n\n<div id=\'dom4\'>\n<div>hello</div>\n\n\n</div>\n\n\n<script>$.templates = {}</script><script async defer src=\'/jswig/partials/clientinclude.js\'></script>\n<script src="/static/js/swig.min.js"></script>\n\n<script>$.dbCache={"1":{"_id":"1","nested":{"_id":"2"}},"3":{"_id":"3","prop":"a"},"4":{"_id":"4","prop":"b"},"5":{"_id":"5"}};$(document).ready(function() {$.each({"dom1":{"template":"./partials/clientinclude.html","model":[{"user":$.dbCache[\'3\']},$.dbCache[\'1\']]},"dom2":{"template":"./partials/clientinclude.html","model":{"user":$.dbCache[\'3\'],"comments":[$.dbCache[\'4\'],$.dbCache[\'5\']]}},"dom3":{"template":"./partials/clientinclude.html"},"dom4":{"template":"./partials/clientinclude.html"}}, function(domid, model) {\n     $(domid).data(\'_template\', $.templates[model.template]);\n     $(domid).data(\'_model\', model.model);});\n});</script>\n\n\n</html>'
        , done);
  });
});
